...
namespace UnityStandardAssets._2D
{
    public class GenericReader : MonoBehaviour
	{
        ...
        const string COLORS_FILE_NAME = "background-colors";
        const string DICTIONARY_FILE_NAME = "dictionary";
        const string OBSTACLES_FILE_NAME = "obstacles";
        const string SENTENCES_FILE_NAME = "sentences";
        ...
        public static Dictionary<String, Color> GetBackgroundColorDictionary()
        {
            ...
            // Declare file.
            TextAsset fileLocation = (TextAsset)Resources.Load(COLORS_FILE_NAME, typeof(TextAsset));

            // Return the text content as a string
            StringReader file = new StringReader(fileLocation.text);    // /Assets/Resources/background-colors.txt
        ...
        protected static Dictionary<String, String[]> GetDictionaryByFilename(String fileName)
		{
            ...
            // Declare file.
            TextAsset fileLocation = (TextAsset)Resources.Load(fileName, typeof(TextAsset));
